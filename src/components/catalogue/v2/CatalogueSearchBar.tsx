...
interface CatalogueSearchBarProps {
  onSearchClick: () => void;
  onReorderClick: () => void;
  /** Show the reorder (buy-again) shortcut. Hidden when the user has no past orders. */
  showReorder?: boolean;
}

export function CatalogueSearchBar({ onSearchClick, onReorderClick, showReorder = false }: CatalogueSearchBarProps) {
  return (
