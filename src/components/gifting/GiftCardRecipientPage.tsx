                ...
                >
                  {copied ? (
                    ...
                    <>
                      ...
                      {redeem.isSuccess ? "Code already used" : "Copy Code"}
                    </>
                  )}
                </Button>
                ...
                {redeem.isSuccess ? (
                  <div className="space-y-3">
                    <div className="rounded-lg bg-green-50 border border-green-200 p-3 text-center">
                      ...
                      <p className="text-xs text-green-700 mt-0.5">You can now pay with wallet at checkout.</p>
                    </div>
