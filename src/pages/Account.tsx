      ...
      <Layout>
        <div className="flex-1 flex flex-col items-center justify-center px-6 py-16">
          ...
          <p className="text-sm text-muted-foreground mb-8 text-center max-w-xs">
            Access your orders, subscriptions and more
          </p>
          ...
          <div className="w-full max-w-sm space-y-3">
            <Button
              ...
              onClick={() => { console.log("Login with Google"); handleSignIn(); }}
            >
            ...
            <Button
              variant="outline"
              className="w-full h-12 gap-2"
              onClick={() => { console.log("Login with Facebook"); handleSignIn(); }}
            >
    ...
    <Layout>
      <div className="px-6 py-10">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-lg font-semibold text-foreground">Jane Doe</h2>
